...
//					$_POST['text'] = str_replace('\r\n', '<br />', $_POST['text']);
		...
		case 'delete':
			// -------------------------------------------------------------------------------------------------------
			// Suppression des messages selectionn¨¦s
			$DeleteWhat = $_POST['deletemessages'];
			...
			if ($MessCategory == 100) {
				...
				while ($CurMess = mysql_fetch_array($UsrMess)) {
					if ($CurMess['message_type'] == $MessCategory) {
						...
						$page .= "</tr><tr>";
						$page .= "<td class=\"b\"> </td>";
						$page .= "<td colspan=\"3\" class=\"b\"><div style='width:100%; word-break: break-all;'>". nl2br( stripslashes( $CurMess['message_text'] ) ) ."</div></td>";
						$page .= "</tr>";
					}
				}
			}
