...
function ShowGalaxyFooter ( $Galaxy, $System,  $CurrentMIP, $CurrentRC, $CurrentSP) {
	...
	$Result .= "\n";
	$Result .= "<tr>";
	$Result .= "<th width=\"30\">" . (MAX_PLANET_IN_SYSTEM + 1) . "</th>";
	$Result .= "<th colspan=7>";
	...
	$Result .= "<td class=c colspan=3>" . $lang['gf_fleetuse'] . "<span id=\"slots\">". $maxfleet_count . "</span> / " . $lang['gf_fleetcnt'] . $fleetmax ."</td>";
